...
The demo scenarios were automatically generated by generative AI in order to realistically simulate an existing scenario and to
copy the popular astroshop store without actually running the necessary hardware. The OTel Demo Service simply simulates the
Open Telemetry traces and spans according to the given scenario without running the infrastructure.
The OTel Demo Service therefore acts as a load generator for observability platforms for testing purposes.
