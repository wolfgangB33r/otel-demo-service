...
- **Multiple Demo Scenarios**: Pre-built scenario scripts simulating different microservices patterns
  - ai-agent-application.py  LangGraph/LangChain RAG commerce agent with GenAI observability fields
...
- **OpenTelemetry Integration**  Generates standard OTLP/HTTP traces with:
  ...
  - GenAI semantic attributes for models, tokens, tool calls, cache hits, and guardrails
