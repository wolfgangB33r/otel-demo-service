...
tracer_web = make_tracer_for_service("sim-service-tree-web")
tracer_api = make_tracer_for_service("sim-service-tree-api")
tracer_auth = make_tracer_for_service("sim-service-tree-auth")
tracer_cache = make_tracer_for_service("sim-service-tree-cache")
tracer_db = make_tracer_for_service("sim-service-tree-db")
